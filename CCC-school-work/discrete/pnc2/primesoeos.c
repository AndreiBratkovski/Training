...
int main(int argc, char **argv)
{
	...
	//
	// Building prime list, sieve sifting through squares up to the square root of  maximum List Size/
	// Upper Bound. Square root trick and odds only traversal in inner loop
	//      
	for (increment1 = 2; increment1 < sqrt(maximumListSize); increment1++)
	{
