	...
	if (maxPrimes == 0)
	{
		...
		while (increment <= upperBound)
		{
			...
			if (increment % 6 == 0)
			{
				...
				{
					for (int i = 2; (i * i) <= possiblePrime1; i++)	// sqrt approximation added (primeregmoa.c)
					{
						...
						{
							break;
						}	// break for (primeregbmoa.c)
					}
					if (counter < 1)	// 2 to 1 (primeregmoa.c)
					{
				...
				{
					for (int i = 2; (i * i) <= possiblePrime2; i++)	//sqrt trick approx. (primeregmoa.c)
					{
		...
		while (primeCounter <= maxPrimes)
		{
			...
			if (increment % 6 == 0)
			{
				...
				if (possiblePrime1 % 2 != 0)
					...
					//
				{
					for (int i = 2; (i * i) <= possiblePrime1; i++)	// sqrt approx added (primeregmoa.c)
					{
						if (possiblePrime1 % i == 0)
						{
							counter++;
				...
				if (possiblePrime2 % 2 != 0)
					...
					//
				{
					for (int i = 2; (i * i) <= possiblePrime2; i++)	// sqrt approx. added (primeregmoa.c)
					{
						if (possiblePrime2 % i == 0)
						{
							counter++;
