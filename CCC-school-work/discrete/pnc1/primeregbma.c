	...
	if (maxPrimes == 0)
	{
		...
		while (increment <= upperBound)
		{
			...
			if (increment % 6 == 0)
			{
				...
				for (int i = 2; (i * i) <= possiblePrime1; i++)
					//
					// Check using square root approximation (primeregma.c)
					//
				{
				...
				for (int i = 2; (i * i) <= possiblePrime2; i++)
					//
					// check using square root approximation (primeregma.c)
					//
				{
	...
	else
	{
		...
		while (primeCounter <= maxPrimes)
		{
			...
			if (increment % 6 == 0)
			{
				...
				for (int i = 2; (i * i) <= possiblePrime2; i++)
					//
					// check usin square root approximation (primeregma.c)
					//
				{
					if (possiblePrime2 % i == 0)
					{
