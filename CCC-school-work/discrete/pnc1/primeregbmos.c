	...
	if (maxPrimes == 0)
	{
		...
		while (increment <= upperBound)
		{
			...
			if (increment % 6 == 0)
			{
				...
				{
					for (int i = 2; i <= sqrt(possiblePrime1); i++)	// sqrt trick added (primeregmos.c)
					{
				...
				{
					for (int i = 2; i <= sqrt(possiblePrime2); i++)	//sqrt trick added (primeregmos.c)
					{
