...
int main()
{
    ...
    else if ((stmp -> data -> engine == NULL) &&
                (stmp -> data -> caboose  == NULL))
    ...
    //////////////////////////////////////////////////////////////////
    //
    // Fourth test: Verify top exists, and is NULL (just like engine)
    //
    fprintf(stdout,     "Test %d: Checking top in new stack ...\n", testno++);
    if (stmp       -> data          == NULL)
        fprintf(stdout, " you have: NULL list element in stack (ERROR)\n");
    else if (stmp  -> top           == stmp -> data -> engine)
    ...
    //////////////////////////////////////////////////////////////////
    //
    // Eighth test: Verify top exists, and is NULL (just like engine)
    //
