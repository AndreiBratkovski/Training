...
int main()
{
    ...
    for(i = 0; i < 4; i++)
    {
        fprintf(stdout, "\nTest %d: Appending %d to end of list ...\n", testno++, data[i]);
        ntmp       = NULL;
        mknode(&ntmp, data[i]);
        fprintf(stdout, " you have: "); 
        result     = append(&ltmp, ltmp -> caboose, ntmp);
        listcat(ltmp);
        fprintf(stdout, "should be: %s\n", output[num++]); 
        fflush (stdout);
    ...
    fprintf(stdout, "\nTest %d: Appending %d to start of list ...\n", testno++, data[i]);
    ntmp         = NULL;
    mknode(&ntmp, data[i]);
    result       = append(&ltmp, ltmp -> engine, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush (stdout);
    ...
    fprintf(stdout, "\nTest %d: Appending %d to second node ...\n", testno++, data[i]);
    ntmp          = NULL;
    mknode(&ntmp, data[i]);
    result        = append(&ltmp, ltmp -> engine -> to, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush (stdout);
    ...
    fprintf(stdout, "\nTest %d: Appending %d to third node ...\n", testno++, data[i]);
    ntmp          = NULL;
    mknode(&ntmp, data[i]);
    result        = append(&ltmp, ltmp -> engine -> to -> to, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush (stdout);
    ...
    fprintf(stdout, "\nTest %d: Appending %d to fifth node ...\n", testno++, data[i]);
    ntmp          = NULL;
    mknode(&ntmp, data[i]);
    result        = append(&ltmp, ltmp -> engine -> to -> to -> to -> to, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush (stdout);
    ...
    fprintf(stdout, "\nTest %d: Appending %d to end -> fro ...\n", testno++, data[i]);
    ntmp          = NULL;
    mknode(&ntmp, data[i]);
    result        = append(&ltmp, ltmp -> caboose -> fro, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush (stdout);
