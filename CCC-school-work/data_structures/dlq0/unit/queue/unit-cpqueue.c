...
int main()
{
    ...
    qtmp -> data                     = ltmp;
    qtmp -> back                     = qtmp -> data -> caboose;
    qtmp -> front                    = qtmp -> data -> engine;
    qtmp2                            = NULL;
    result                           = cpqueue(qtmp, &qtmp2);
    ...
    //
    i                                = qtmp -> data -> engine -> to -> VALUE;
    qtmp -> data -> engine -> to -> VALUE  = 29;
    fprintf(stdout,     "Test %d: Checking queues (1 of 2) ...\n", testno++);
    if (qtmp2 -> data -> engine -> to -> VALUE == i)
    ...
    if (qtmp -> data -> engine -> to -> VALUE == 29)
        fprintf(stdout, " you have: difference detected (SUCCESS)\n");
    else
        fprintf(stdout, " you have: ERROR state\n");
    ...
    if (qtmp2 -> front != qtmp2 -> data -> engine)
    ...
    if (qtmp2 -> back != qtmp2 -> data -> caboose)
