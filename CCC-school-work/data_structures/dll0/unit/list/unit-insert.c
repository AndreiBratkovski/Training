...
int main()
{
	...
	for(i = 0; i < 4; i++)
	{
		fprintf(stdout, "\nTest %d: Inserting %d before first node of list ...\n", testno++, data[i]);
		ntmp       = NULL;
		mknode(&ntmp, data[i]);
		result     = insert(&ltmp, ltmp -> engine, ntmp);
		fprintf(stdout, " you have: "); 
		listcat(ltmp);
		fprintf(stdout, "should be: %s\n", output[num++]); 
		fflush(stdout);
	...
	fprintf(stdout, "\nTest %d: Inserting %d before last node of list ...\n", testno++, data[i]);
	ntmp       = NULL;
	mknode(&ntmp, data[i]);
	result         = insert(&ltmp, ltmp -> caboose, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush(stdout);
	...
	fprintf(stdout, "\nTest %d: Inserting %d before second to last node ...\n", testno++, data[i]);
	ntmp       = NULL;
	mknode(&ntmp, data[i]);
	result         = insert(&ltmp, ltmp -> caboose -> fro, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush(stdout);
	...
	fprintf(stdout, "\nTest %d: Inserting %d before third to last node ...\n", testno++, data[i]);
	ntmp       = NULL;
	mknode(&ntmp, data[i]);
	result         = insert(&ltmp, ltmp -> caboose -> fro -> fro, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush(stdout);
	...
	fprintf(stdout, "\nTest %d: Inserting %d before fifth to last node ...\n", testno++, data[i]);
	ntmp       = NULL;
	mknode(&ntmp, data[i]);
	result = insert(&ltmp, ltmp -> caboose -> fro -> fro -> fro -> fro, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush(stdout);
	...
	fprintf(stdout, "\nTest %d: Inserting %d before first node's -> to ...\n", testno++, data[i]);
	ntmp       = NULL;
	mknode(&ntmp, data[i]);
	result   = insert(&ltmp, ltmp -> engine -> to, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush(stdout);
