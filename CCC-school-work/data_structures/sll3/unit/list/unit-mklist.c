...
int main()
{
	...
	for (i = 0; i < 4; i++)
	{
		...
		fprintf(stdout, "Test %d: Checking list components (engine) ...\n", testno++);
		if (ltmp2               == NULL)
			fprintf(stdout, " you have: NULL list\n");
		else if (ltmp2 -> engine == NULL)
			fprintf(stdout, " you have: NULL\n");
		else
		...
		fprintf(stdout, "Test %d: Checking list components (caboose) ...\n", testno++);
		if (ltmp2               == NULL)
			fprintf(stdout, " you have: NULL list\n");
		else if (ltmp2 -> caboose  == NULL)
			fprintf(stdout, " you have: NULL\n");
		else
			fprintf(stdout, " you have: NOT NULL\n");
		fprintf(stdout, "should be: NULL\n\n");
