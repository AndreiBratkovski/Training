...
int main()
{
	...
	fprintf(stdout, " you have: ");
	ltmp         = insert(ltmp, ltmp -> caboose, mknode(data[i]));
	displayf(ltmp, 0);
	fprintf(stdout, "should be: %s\n\n", output[num++]); 
	fflush(stdout);
	i            = i + 1;

	fprintf(stdout, "Test %d: Inserting %d before second to caboose node ...\n", testno++, data[i]);
	fprintf(stdout, " you have: ");
	...
	fprintf(stdout, "Test %d: Inserting %d before third to caboose node ...\n", testno++, data[i]);
	fprintf(stdout, " you have: ");
	...
	fprintf(stdout, "Test %d: Inserting %d before fifth to caboose node ...\n", testno++, data[i]);
	fprintf(stdout, " you have: ");
	...
	fprintf(stdout, " you have: ");
	ltmp         = insert(ltmp, ltmp -> engine -> to, mknode(data[i]));
	displayf(ltmp, 0);
	fprintf(stdout, "should be: %s\n\n", output[num++]); 
	fflush(stdout);
	i            = i + 1;
