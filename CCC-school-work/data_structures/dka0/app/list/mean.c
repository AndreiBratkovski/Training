...
//////////////////////////////////////////////////////////////////////
//
// OPERATION:MEAN - Determine the AVERAGE of info values from a list
//                  of nodes.
//
int main()
{
	...
	tmp = myList->engine;
	result = mknode(tmp->contents);

	//
	// Add up total from myList
	//
	while (tmp->to != NULL)
	{
		tmp = tmp->to;
	...
	//
	// Calculate average, then set average(total) to result->contents
	//
	total = total / index;
