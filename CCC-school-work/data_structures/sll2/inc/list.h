...
#include "node.h"                         // list relies on node
...
typedef struct list               List;   // we deserve nice things
typedef unsigned long long int    ulli;   // short name
typedef unsigned char             uc;     // short name
...
List *sortlist  (List *, int);            // sort list (by mode)
