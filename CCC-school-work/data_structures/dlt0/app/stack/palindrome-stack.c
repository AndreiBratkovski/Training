...
/*****************************************************************************
 ** dls0 extra credit program - the purpose of this program is to test your
 ** palindrome processing       skills at using linked stacks to aid you in
 ...
 **                    manifested within nodes in the resulting stack)
 **              NOTE: be sure your program accepts spaces, even if it will
 **                    only ignore them in the ultimate processing.
 **
 ** 3.  copy/stack it: store a copy of the stack for reference/modification
 **              NOTE: don't reinvent the wheel. Points will be awarded for
 **                    appropriately utilizing stack operations in your 
 **                    solution to this problem.
 **
 ** 4.   compare them: do a node-by-node comparison of both stacks in order
 **                    to determine whether the input (ignoring spaces) is
 **                    a palindrome or not.
 **              NOTE: comparison is done using stack functions
 **
 ...
 **                    stack) along with its palindrome status.
 **
 ...
 ** stack function usage, correctness, and non-reinventing of wheels. It also
 ** wouldn't hurt to comment your code and ensure it is indented and readable.
 **
 ** NOTE: the aim here is to exclusively use stack functions; usage of list
 **       functions where stack functions could be used will result in 
