...
int main(int argc, char **argv)
{
	...
	//
	// Max prime quantity algorithm using built in square root function in math.h
	//
	if (maxPrimes == 0)
	{
	...
	//
	// Same as above algorithm, but without maxprime quantity set
	//
	else
	{
		if (argc > 4) {increment = lowerBound;}
