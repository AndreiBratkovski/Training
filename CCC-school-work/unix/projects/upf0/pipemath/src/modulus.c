//////////////////////////////////////////////////////////////////////
//
// modulus.c  - program that accepts input from both STDIN and the 
//              first command-line argument, and displays the result
//              of the operation to STDOUT.
//
//              this program performs a modulus operation on the two
//              inputs, displaying the result of STDIN % ARG1 to
//              STDOUT. Modulus is commonly known as the remainder
//              integer division (ie no decimal point) operations.
//
